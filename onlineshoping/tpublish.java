...
public class tpublish extends HttpServlet
{
	...
	try
	{
		...
		String alph=req.getParameter("selectpub");
		String qry="select title,authors,pname,subject,rate from books where pname = '"+alph+"' ";
